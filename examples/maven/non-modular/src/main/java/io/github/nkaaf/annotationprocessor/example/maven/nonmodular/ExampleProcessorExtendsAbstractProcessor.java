package io.github.nkaaf.annotationprocessor.example.maven.nonmodular;
...
@SupportedAnnotationTypes("de.technikkaa.annotationprocessor.example.maven.nonmodular.ExampleAnnotation")
@AnnotationProcessor
